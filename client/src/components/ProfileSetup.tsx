...
export default function ProfileSetup({ onProfileReady, onBack }: ProfileSetupProps) {
  ...
  const handleCreateProfile = async () => {
    ...
    try {
      ...
      if (uploadedPhoto) {
        // Store uploaded image directly as avatar image (AI-free flow)
        profileData.profileImage = uploadedPhoto;
        // Keep raw base64 copy without data URL prefix for optional future processing
        profileData.originalPhoto = uploadedPhoto.split(',')[1];
      }
      ...
      >
        ...
        <Card className="w-full max-w-md p-10 bg-black border-4 border-white shadow-2xl relative z-30">
          ...
          <div className="space-y-3">
            <Button
              size="lg"
              className="w-full text-lg sm:text-xl py-5 sm:py-6 bg-red-500 hover:bg-red-600 text-white font-black border-4 border-white whitespace-normal leading-tight"
